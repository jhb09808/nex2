...
export default function Welcome() {
  ...
  return (
    ...
    >
      ...
      >
        {loggedOut && (
          <div style={{ position: "relative", zIndex: 2, marginBottom: SECTION_GAP, padding: "10px 16px", background: "rgba(16, 80, 50, 0.35)", border: "1px solid rgba(80, 220, 140, 0.4)", borderRadius: 8, display: "flex", alignItems: "center", gap: 10, backdropFilter: "blur(12px)", flex: "none" }}>
